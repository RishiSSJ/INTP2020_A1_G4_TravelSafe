...
<body>
    ...
    <main class="page" style="margin-top: 100px;">
        <section class="clean-block about-us">
            <div class="container">
                <div class="block-heading"><img src="assets/img/logo/logo1.png" style="height: 150px;">
                    <h2 class="text-dark">THANK YOU</h2>
                    <p>Your travel package has been booked.</p>
                </div>
                <div class="row justify-content-center">
                    <div class="col-sm-6 col-lg-3 offset-lg-0">
                        <div class="card clean-card text-center">
                            <div class="card-body info">
                                <h4 class="card-title">Yukta Bhanushali</h4>
                                <p class="card-text">TE IT(A) - 02</p>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card clean-card text-center">
                            <div class="card-body info">
                                <h4 class="card-title">Rishikesh Jadhav</h4>
                                <p class="card-text">TE IT(A) - 10<br></p>
                                <div class="icons"><a href="#"><i class="icon-social-facebook"></i></a><a href="#"><i class="icon-social-instagram"></i></a><a href="#"><i class="icon-social-twitter"></i></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-3 offset-lg-0">
                        <div class="card clean-card text-center">
                            <div class="card-body info">
                                <h4 class="card-title">Rutuja Kapse</h4>
                                <p class="card-text">TE IT(A) - 15<br></p>
                                <div class="icons"><a href="#"><i class="icon-social-facebook"></i></a><a href="#"><i class="icon-social-instagram"></i></a><a href="#"><i class="icon-social-twitter"></i></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-3">
                        <div class="card clean-card text-center">
                            <div class="card-body info">
                                <h4 class="card-title">Deep Patel</h4>
                                <p class="card-text">TE IT(A) - 20<br></p>
                                <div class="icons"><a href="#"><i class="icon-social-facebook"></i></a><a href="#"><i class="icon-social-instagram"></i></a><a href="#"><i class="icon-social-twitter"></i></a></div>
                            </div>
                        </div>
                    </div>
