...
<head>
    ...
    <title>Payment - TravelSafe</title>
...
<body>
    ...
    <main class="page payment-page" style="margin-top: 100px;">
            ...
            <div class="container">
                ...
                <form>
                    <div class="products">
                        ...
                        <div class="item"><span class="price"><strong>₹29,000</strong><br></span>
                            <p class="item-name">Your Package</p>
                        </div>
                        <div class="item"><span class="price"><strong>₹1,500</strong><br></span>
                            <p class="item-name">GST</p>
                        </div>
                        <div class="item"><span class="price"><strong>₹500</strong><br></span>
                            <p class="item-name">Discount</p>
                        </div>
                        <div class="total"><span>Total</span><span class="price"><strong>₹30,000</strong><br></span></div>
                    </div>
                    <div class="card-details">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group"><a class="btn btn-primary btn-block" role="button" href="end.php">Proceed</a></div>
                            </div>
                        </div>
                    </div>
                </form>
