                            ...
                            <div class="col-12 col-md-6 col-lg-10 offset-lg-1" id="message">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-12 col-sm-6 col-md-12 col-lg-6">
                                        <div class="form-group"><label for="from-calltime">Package</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend"></div><select class="form-control" id="from-calltime" name="call time"><optgroup label="Package"><option value="Null" selected="">Select</option><option value="Kerala">Kerala</option><option value="Rajasthan">Rajasthan</option></optgroup></select></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col"><a class="btn btn-primary btn-block" role="button" href="payment-m.php">Proceed&nbsp;<i class="fa fa-chevron-circle-right"></i></a></div>
                                    </div>
                                </div>
